...
module.exports = class VideoPlayerView extends View {
  ...
  initialize(serializeState) {
    atom.workspaceView.command("video-player:play", () => this.play());
    atom.workspaceView.command("video-player:stop", () => this.stop());
    atom.workspaceView.command("video-player:toggle-back-forth", () => this.toggleBackForth());
    atom.workspaceView.command("video-player:toggle-control", () => this.toggleControl());
    atom.workspaceView.command("video-player:reload-source", () => this.reloadSrc());
  }
