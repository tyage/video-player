...
module.exports = class VideoPlayerView extends View {
  ...
  initialize(serializeState) {
    ...
    workspace.command("video-player:play", () => this.play());
    workspace.command("video-player:stop", () => this.stop());
    workspace.command("video-player:toggle-back-forth", () => this.toggleBackForth());
    workspace.command("video-player:toggle-control", () => this.toggleControl());
    workspace.command("video-player:reload-source", () => this.reloadSrc());
  }
